...
func (e *RedisCommandExecutor) GetDefinition() NodeDefinition {
	return NodeDefinition{
		...
		Name:        "Redis Command",
		Description: "Runs Redis commands such as GET, SET, DEL, HGET, and HSET",
		Icon:        "Database",
		Category:    "DATABASE",
		Retryable:   true,
		Params: []ParamDefinition{
			{
				...
				Type:        "credential",
				Required:    false,
				Description: "Select an encrypted credential containing the Redis password",
			},
			{
				Name:        "address",
				Label:       "Redis Address",
				...
				Required:    true,
				Description: "Redis server address, for example localhost:6379",
			},
			{
				Name:        "password",
			...
			},
			{
				...
				Required:    true,
				Description: "Choose the Redis command to run",
			},
			{
				Name:        "key",
				Label:       "Redis Key",
			...
			},
			{
				...
				Type:        "text",
				Required:    false,
				Description: "Field name inside a Redis hash key",
			},
			{
				Name:        "value",
				...
				Type:        "textarea",
				Required:    false,
				Description: "Value to write or append",
			},
		},
	}
}
