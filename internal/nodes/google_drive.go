...
func (e *GoogleDriveExecutor) GetDefinition() NodeDefinition {
	return NodeDefinition{
		...
		Name:        "Google Drive",
		Description: "Uploads files or lists files in Google Drive using a service account",
		Icon:        "Folder",
		...
		Params: []ParamDefinition{
			...
			},
			{
				...
				Required:    true,
				Description: "Choose LIST to list files or UPLOAD to upload a new file",
			},
			{
				Name:        "folder_id",
				...
				Type:        "text",
				Required:    false,
				Description: "Parent Google Drive folder ID for listing or uploading files",
			},
			{
				Name:        "filename",
				...
				Type:        "text",
				Required:    false,
				Description: "Filename to use when uploading to Google Drive",
			},
			{
				Name:        "content",
