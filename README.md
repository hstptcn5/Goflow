...
- UX Milestone 4 Execution Debugging: Added an editor execution selector, canvas execution overlay, failed-path edge highlight, full-workflow retry, server-side execution replay, cancel action, contextual node error actions, and redacted debug bundle preview/copy.
